...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkbox.equals("true"))
        {
            ...
            //if the user pressed (remember me ) last time he entered without logging out :
            //he will be directed to the ProductsActivity instead of the SignInActivity page)
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.equals("admin") && password.equals("admin")) {
                    ...
                    //make the (rememberMe) button inactivated as (isCheckedRm[0]=="false")
